...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_MUTE, KC_PGDN,
        MO(_FN), KC_LCTL, KC_LOPT, KC_LCMD, MO(_LR), KC_BSPC, KC_SPC,  MO(_RS), KC_RCMD, KC_HOME, KC_END,  KC_LEFT, KC_DOWN, KC_RGHT, RESET 
    ),
    [_FN] = LAYOUT(
    ...
    [_LR] = LAYOUT(
        ...
        KC_NO,   _______, _______, _______, _______, _______, _______, KC_0,    KC_DOT,  _______, _______, _______, _______, _______, _______
    ),
    [_RS] = LAYOUT(
